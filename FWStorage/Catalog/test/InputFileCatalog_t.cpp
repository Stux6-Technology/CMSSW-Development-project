...
TEST_CASE("InputFileCatalog with Rucio data catalog", "[FWStorage/Catalog]") {
  ...
  SECTION("notLogicalFileName") {
    REQUIRE(not edm::InputFileCatalog::notLogicalFileName("/foo/bar"));
    REQUIRE(not edm::InputFileCatalog::notLogicalFileName(""));
    REQUIRE(edm::InputFileCatalog::notLogicalFileName("file:/foo/bar"));
  }
