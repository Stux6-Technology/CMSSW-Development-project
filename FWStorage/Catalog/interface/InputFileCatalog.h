...
namespace edm {
  ...
  public:
    ...
    // Configured File Names including a ":" are not Logical File Names.
    static bool notLogicalFileName(std::string const& configuredFileName);
  ...
  private:
    ...
    std::string physicalFileName(unsigned int iCatalog, std::string const& configuredFileName, bool notLFN) const;
